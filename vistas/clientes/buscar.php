...
<?php include_once '../../includes/navbar.php'?>
    <div class="container">
        ...
        <div class="row justify-content-center">
            <form action="/Practica-No-9/controladores/clientes/buscar.php" method="GET" class="col-lg-8 border bg-light p-3">
                <div class="row mb-3">
                    <div class="col">
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="cliente_nit">Codigo NIT del cliente</label>
